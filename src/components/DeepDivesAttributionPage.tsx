...
const rowDefs: RowDef[] = [
  ...
  { key: 'redditSpend', label: 'Reddit Spend', group: 'Channel Spend', format: v => `$${v.toLocaleString()}`, higherIsBetter: false },
  ...
  { key: 'redditHcpa', label: 'Reddit hCPA', group: 'Channel hCPA', format: v => `$${v}`, higherIsBetter: false },
  ...
  { key: 'redditHroas', label: 'Reddit hROAS', group: 'Channel hROAS', format: v => `${v}%`, higherIsBetter: true },
